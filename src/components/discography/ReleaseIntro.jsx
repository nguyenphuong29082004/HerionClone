  ...
  return (
    <div>
        <div className="text-center px-4 py-12 max-w-6xl mx-auto">
            <h2 className='text-[95px] font-style_harley text-harley'>Discography</h2>
            <h2 className='font-style_staaliches text-3xl mb-16 tracking-wide uppercase'>Release Pages</h2>
