    ...
    return (
        <div className='flex flex-col items-center mt-8 px-10'>
            <div className="text-center px-4 py-12 max-w-6xl mx-auto">
                <h2 className='sm:text-[95px] text-[60px] font-style_harley text-harley'><span  className='sm:text-9xl text-8xl'>9 </span>Template</h2>
                <h2 className='font-style_staaliches sm:text-3xl text-xl mb-12 tracking-wide uppercase'>Inner Pages</h2>
